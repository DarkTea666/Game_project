...
def ray_to_border(x0, y0, x1, y1,
                  ...
                  top_border,
                  bottom_border):
    if (x1>=x0 and y1>=y0 or x1>=x0 and y1<=y0) and abs(x1-x0)>=abs(y1-y0):
        y = (right_border-x0)/(x0-x1)*(y0-y1)+y0
        return (right_border, y)
    elif (x1<=x0 and y1>=y0 or x1>=x0 and y1>=y0) and abs(x1-x0)<=abs(y1-y0):
        x = (top_border-y0)/(y0-y1)*(x0-x1)+x0
        return (x, top_border)
    elif (x1<=x0 and y1<=y0 or x1<=x0 and y1>=y0) and abs(x1-x0)>=abs(y1-y0):
        y = (left_border-x0)/(x0-x1)*(y0-y1)+y0
        return (left_border, y)
    elif (x1>=x0 and y1<=y0 or x1<=x0 and y1<=y0) and abs(x1-x0)<=abs(y1-y0):
        x = (bottom_border-y0)/(y0-y1)*(x0-x1)+x0
        return (x, bottom_border)
